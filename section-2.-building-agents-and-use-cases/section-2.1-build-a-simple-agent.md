...
In a non-lab environment and with MCP, you could expose agents to third parties, add memory categories, or allow the agent to learn from past executions. For this lab, we will not change those settings.
{% endhint %}
