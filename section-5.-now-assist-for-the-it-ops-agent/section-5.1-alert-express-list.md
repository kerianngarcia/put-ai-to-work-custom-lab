...
```
GET https://servicenow-events-or-lab-guidebo.gitbook.io/world-forums-learning-labs-2026/world-forums-and-summits-learning-labs/put-ai-to-work-shop-for-service-operations/section-5.-now-assist-for-the-it-ops-agent/section-5.1-alert-express-list.md?ask=&goal=
```
