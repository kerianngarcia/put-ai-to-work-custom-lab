...
In this section, you will move from using AI to building AI.

You will create a simple agent, add tools, connect the agent to an agentic workflow, and explore an optional incident investigation use case.
...
☐ Wrap an Agent in an agentic workflow.

☐ Explore an optional outage investigation scenario.
{% endhint %}
